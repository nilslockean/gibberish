...
*/    var aa = __webpack_require__(0), n = __webpack_require__(1), r = __webpack_require__(6);
    function x(a) {
    ...
    function ja(a, b, c, d, e, f, g, h, l) {
        da = !1, ea = null, function ca(a, b, c, d, e, f, g, h, l) {
    ...
    function wa(a, b, c) {
        ...
        a.currentTarget = va(c), function ka(a, b, c, d, e, f, g, h, l) {
    ...
    var zb = {
        ...
        extractEvents: function(a, b, c, d) {
            ...
            Qa(e), f = e) : f = null, (a = pb ? function xb(a, b) {
                switch (a) {
                  case "compositionend":
                    return vb(b);
    ...
    function Rb(a) {
        a._valueTracker || (a._valueTracker = function Qb(a) {
    ...
    function tc(a, b, c, d) {
        ...
        (null !== e ? 0 === e.type : !d && (2 < b.length && ("o" === b[0] || "O" === b[0]) && ("n" === b[1] || "N" === b[1]))) || (function qc(a, b, c, d) {
            ...
            return !1;
        }(b, c, e, d) && (c = null), d || null === e ? function oc(a) {
    ...
    function pg(a) {
        ...
        if (null === c && x("311"), 0 < eg) {
            ...
            if (null !== dg) {
                ...
                if (void 0 !== e) {
                    ...
                    c.eagerReducer = a, c.eagerState = f, [ f, d ];
                }
            }
        ...
        null !== d) {
            ...
            b.baseState = e, c.eagerReducer = a, c.eagerState = f;
        }
    ...
    function wg(a, b, c) {
        ...
        if (a === Xf || null !== d && d === Xf) if (cg = !0, a = {
            ...
            if (b.last = f, 0 === a.expirationTime && (null === d || 0 === d.expirationTime) && null !== (d = b.eagerReducer)) try {
    ...
    function Tg(a, b, c) {
        ...
        switch (b.expirationTime = 0, b.tag) {
          ...
          case 16:
            ...
            b.effectTag |= 2), f = b.pendingProps, a = function hf(a) {
                var b = a._result;
                switch (a._status) {
                  case 1:
                    return b;
            ...
            }(e), b.type = a, e = b.tag = function We(a) {
        ...
        switch (b.tag) {
          ...
          case 5:
            ...
            if (null != c) {
                ...
                b.updateQueue = null, null !== f && function Ce(a, b, c, d, e) {
          ...
          case 13:
            ...
            0 === c.timedOutAt && (c.timedOutAt = lf())), null !== a && function uh(a, b) {
                for (var c = a; ;) {
                    if (5 === c.tag) {
                        var d = c.stateNode;
    ...
    function Zh(a, b) {
        ...
        d = b.firstEffect) : d = b : d = b.firstEffect, ue = Bd, ve = function Pd() {
            var a = Nd();
            if (Od(a)) {
        ...
        0 === (b = (b = b.childExpirationTime) > c ? b : c) && (Fh = null), function $h(a, b) {
                      ...
                      case 5:
                        ...
                        if (f = b.type, null !== e && null != b.stateNode) nh(e, b, f, g, h), e.ref !== b.ref && (b.effectTag |= 128); else if (g) {
                            ...
                            if (Eg(b)) {
                                ...
                                m = b, e = f, p = g, k = 9 === h.nodeType ? h : h.ownerDocument, l === fe.html && (l = ge(e)), 
                                l === fe.html ? "script" === e ? ((e = k.createElement("div")).innerHTML = "<script><\/script>", 
    ...
    function fi(a, b, c, d, e) {
        a.expirationTime = d, 0 !== e || di() ? 0 < e && (a.timeoutHandle = ye(function Ai(a, b, c) {
    ...
    function Si(a, b, c, d, e) {
        ...
        if (f) {
            ...
            if (f = c._reactRootContainer = function Ri(a, b) {
    ...
    function Ti(a, b) {
        ...
        return Qi(b) || x("200"), function Mi(a, b, c) {
...
/***/ function(module, exports, __webpack_require__) {
    // Imports
    (exports = module.exports = __webpack_require__(10)(!1)).push([ module.i, "@import url(https://fonts.googleapis.com/css?family=Lora|Mukta);", "" ]), 
    // Module
...
/***/ function(module, __webpack_exports__, __webpack_require__) {
    ...
    var extendStatics, react = __webpack_require__(0), react_default = /* */ __webpack_require__.n(react), react_dom = __webpack_require__(3), react_dom_default = /* */ __webpack_require__.n(react_dom), __extends = (__webpack_require__(2), 
    undefined && undefined.__extends || (extendStatics = function(d, b) {
        ...
        new __());
    })), form_input = function(_super) {
        function FormInput(props) {
            var _this = _super.call(this, props) || this;
            return _this.handleSubmit = function(e) {
                e.preventDefault(), _this.state.text.length && (_this.props.newSheetFormHandler(e, _this.state.text), 
                _this.setState({
                    text: ""
                }));
            }, _this.state = {
                text: ""
            }, _this.handleChange = _this.handleChange.bind(_this), _this.handleSubmit = _this.handleSubmit.bind(_this), 
            _this;
        }
        return __extends(FormInput, _super), FormInput.prototype.handleChange = function(e) {
            this.setState({
                text: e.target.value
            });
    ...
    }(react_default.a.Component), sheet_button = function(props) {
    ...
    }, sheet_editor_extends = undefined && undefined.__extends || function() {
    ...
    }(), sheet_editor = function(_super) {
        function SheetEditor(props) {
            var _this = _super.call(this, props) || this;
            return _this.state = {
                names: []
            }, _this.deleteButtonHandler = _this.deleteButtonHandler.bind(_this), _this.clickSheetNameHandler = _this.clickSheetNameHandler.bind(_this), 
            _this.newSheetFormHandler = _this.newSheetFormHandler.bind(_this), _this;
        }
        return sheet_editor_extends(SheetEditor, _super), SheetEditor.prototype.componentDidMount = function() {
            var _this = this;
        ...
        }, SheetEditor.prototype.deleteButtonHandler = function(e, sheetIndex) {
            var _this = this;
            return google.script.run.withSuccessHandler(function(data) {
                return _this.setState({
                    names: data
                });
            }).withFailureHandler(function(error) {
        ...
        }, SheetEditor.prototype.clickSheetNameHandler = function(e, sheetName) {
            var _this = this;
            return google.script.run.withSuccessHandler(function(data) {
                return _this.setState({
                    names: data
        ...
        }, SheetEditor.prototype.newSheetFormHandler = function(e, newSheetTitle) {
            var _this = this;
            return google.script.run.withSuccessHandler(function(data) {
                return _this.setState({
                    names: data
            ...
            var _this = this, names = this.state.names;
            return react_default.a.createElement("div", null, react_default.a.createElement(form_input, {
                newSheetFormHandler: this.newSheetFormHandler
            }), names.length ? names.map(function(name) {
                return react_default.a.createElement(sheet_button, {
                    name: name,
                    deleteButtonHandler: _this.deleteButtonHandler,
                    clickSheetNameHandler: _this.clickSheetNameHandler,
                    key: name.sheetName
                });
            }) : null);
        }, SheetEditor;
    ...
    react_dom_default.a.render(react_default.a.createElement(sheet_editor, null), document.getElementById("index"));
}
/******/ ]);