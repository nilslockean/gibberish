...
/***/ function(module, __webpack_exports__, __webpack_require__) {
    ...
    var messages = __webpack_require__(1), sv_messages = __webpack_require__(2), _locales_i18n = function(lang, messageName) {
        ...
        var html = HtmlService.createHtmlOutputFromFile("sidebar").setTitle("Gibberish");
        ...
        try {
            ...
            }(_locales_i18n(lang, error.message));
        }
        ...
        if (!cursor) throw new Error("error_no_caret");
        if (!cursor.insertText(text)) throw new Error("error_no_insert");
    };
